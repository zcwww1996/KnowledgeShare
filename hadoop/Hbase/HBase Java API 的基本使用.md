...
# 1. 简述
HBase 有两个主要的版本，分别是 1.x 和 2.x ，两个版本的 Java API 有所不同，1.x 中某些方法在 2.x 中被标识为 `@deprecated` 过时。所以关于 API 的样例，需要区分 1.x 和 2.x 两个版本。

同时使用的客户端的版本必须与服务端版本保持一致，如果用 2.x 版本的客户端代码去连接 1.x 版本的服务端，会抛出 `NoSuchColumnFamilyException` 等异常。
...
这里选取的 HBase Client 的版本为2.1.x版本的最新版 2.1.10。
...
[![deprecated.png](https://gd-hbimg.huaban.com/41fa07748a663a166e700a06aebe25934ae749487e98-yB1E7s)](https://s2.loli.net/2022/10/18/tf174sPoyAiObdS.png)
...
[![hbase-arc.png](https://i0.wp.com/s2.loli.net/2022/10/18/VAc3bZqXWanJDzi.png)](https://gd-hbimg.huaban.com/ffe980a40b8b2ce179ce3f1913eb7f284ebecfddb419-BTz4X0_fw658)

Connection 对象和实际的 Socket 连接之间的对应关系如下图：

[![hbase-connection.png](https://i0.wp.com/s2.loli.net/2022/10/18/OnQH4thzwiDrTFX.png)](https://gd-hbimg.huaban.com/6c02761477d62906f44daf1a471e2f706a0cfd4d890d-6mocHo_fw658)
