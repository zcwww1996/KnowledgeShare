...
参考：https://ververica.cn/developers/advanced-tutorial-2-time-depth-analysis
...
![](https://ververica.cn/wp-content/uploads/2019/09/003-1024x499.png)
...
*   第二，如果在程序里面收到了一个 Long.MAX\_VALUE 这个数值的 watermark，就表示对应的那一条流的一个部分不会再有数据发过来了，它相当于就是一个终止的一个标志。
